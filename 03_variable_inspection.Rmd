...
data_raw <- st_read("G:/ai_daten/P1047_SUBDENSE/liverpool_paper/01_data_input/in_vera/251013/grid_full.gpkg")  #Pfad Denise


# par_with_dep_raw <- st_read("G:/ai_daten/P1070_USBW/MbE_MUC/workfiles_03_git/data_prep_output/parcels_10_final_data.gpkg") 
# var_desc <- read.csv("./workfiles_03_git/data_models/240925_MbE_MUC_data - Erklärende Variablen.csv")
```
